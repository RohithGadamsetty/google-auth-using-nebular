...
var AppComponent = /** @class */ (function () {
    function AppComponent(iconLibraries) {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(nbAuthService, router) {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        return new Promise(function (res) {
            _this.nbAuthService.onTokenChange()
...
var OauthComponent = /** @class */ (function () {
    function OauthComponent(nbAuthService, router) {
        var _this = this;
        this.nbAuthService = nbAuthService;
        this.router = router;
    ...
    OauthComponent.prototype.login = function () {
    ...
    OauthComponent.ctorParameters = function () { return [
        { type: _nebular_auth__WEBPACK_IMPORTED_MODULE_3__["NbAuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var OauthService = /** @class */ (function () {
    ...
    OauthService.prototype.getUserProfileInfo = function (access_token) {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(nbAuthService, oauthService, router) {
        this.nbAuthService = nbAuthService;
    ...
    ProfileComponent.prototype.getAccessToken = function () {
        var _this = this;
        this.nbAuthService.onTokenChange()
            .subscribe(function (token) {
            if (token && token.isValid()) {
                console.log(token.getPayload());
                _this.getUserProfileInfo(token.getPayload().access_token);
            }
        });
    };
    ProfileComponent.prototype.getUserProfileInfo = function (access_token) {
        var _this = this;
        this.oauthService.getUserProfileInfo(access_token).subscribe(function (UserProfileResponse) {
            console.log(UserProfileResponse);
            _this.userProfileInfo = UserProfileResponse;
        });
    };
